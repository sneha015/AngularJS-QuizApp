...
//servide to fetch data and pass it to controllers, it seperates the concerns
//controller dont worry about where the data came from.
...
(function(){
    ...
    var quizQuestions  = [
        ...
        },
        {
            ...
            possibilities: [
                {
                    answer: "http://seaturtles911.org/image/green-seaturtle-1.jpg"
                },
                {
    ...
    var turtlesData = [
        {
            type: "Green Turtle",
            image_url: "http://seaturtles911.org/image/green-seaturtle-1.jpg",
